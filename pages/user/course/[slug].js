    ...
    return(
          ...
          >
             {course.lessons.map((lesson,index)=>(
              ...
              >
                  ...
                  <CheckCircleFilled className=" text-primary ml-2"
     ...
     <div className="col">
         ...
         <div className="col alert alert-primary square">
            ...
            ? (<span className=" pointer" style={{float:"right"}} onClick={markIncomplete}>
            Mark as incomplete
        </span>
        ):(
            <span className="pointer"style={{float:"right"}} onClick={markCompleted}>
            Mark as completed
        </span>
        )}
         </div>
