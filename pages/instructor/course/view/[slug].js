...
const CourseView=()=>{
    ...
    const handleVideo =async(e)=>{
       ...
       try{
        ...
        const {data}=await axios.post(`/api/course/video-upload/${course.instructor._id}`,
        videoData,{
            onUploadProgress:(e)=>{
                     ...
                     <div className ="media-body pt-2">
                         <div className="row">
                             <div className="col">
                                ...
                                <p style={{marginTop:"-15px",fontSize:"15px"}}>{course.category}</p>
    ...
    <div className="row pb-5">
        <div className="col lesson-list">
            <h4>{course && course.lessons && course.lessons.length}Lessons
            </h4>
