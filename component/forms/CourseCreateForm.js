      ...
      {values && (
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group" style={{ width: "100%" }}>
            ...
            >
              <Option value="SHORT AND SWEETS COURSES FOR YOU!">
                SHORT AND SWEETS COURSES FOR YOU!
              </Option>
              <Option value="New and noteworthy in Web Development">
                New and noteworthy in Web Development
              </Option>
              <Option value="Featured courses in Python">
                Featured courses in Python
              </Option>
              <Option value="Recommended for you">Recommended for you</Option>
              <Option value="Featured courses in Web Development">
